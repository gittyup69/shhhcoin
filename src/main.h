...
static const unsigned int DEFAULT_BLOCK_PRIORITY_SIZE = 700;
...
static const int64 DUST_SOFT_LIMIT = 500000; // 0.005 SHHH
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1;   // 0.00000001 SHHH mininput
/** No amount larger than this (in Mitsuaki) is valid */
static const int64 MAX_MONEY = 5275558 * COIN;
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 8763428 / 250;
    }
